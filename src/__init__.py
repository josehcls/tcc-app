...
import src.integration.recipe_integration as recipes
import src.integration.batch_integration as batches
import src.integration.device_integration as devices
...
def get_devices():
    ...
    response = devices.get_devices(page, size)
    return app.response_class(
